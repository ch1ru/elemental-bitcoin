...
namespace LBitcoin {
        ...
        /*Creates a locking script for pay-to-script*/
        ...
        /*Creates a locking script for pay-to-pubkey*/
        ...
        public BitcoinAddress address(bool testnet = false) {
            ...
            if(this.isP2PKH()) {
                ...
                return new BitcoinAddress(addr, segwit: false);
            }
            else if(this.isP2SH()) {
                byte[] h160 = cmds_[1];
        ...
        public bool evaluate(BigInteger z, List<byte[]> witness) {
            ...
            while (cmds_.Count() > 0) {
                ...
                try {
                    if (cmd.Length == 1 && (cmd[0] > 0x4b) || cmd[0] == 0x00) { //command
                        ...
                        stack.Push(cmd); 
                        /*Check for bip16 and bip141 patterns, if found, push commands for execution*/
