...
namespace LBitcoin {
    ...
    class HDPublicKey : PublicKey {
        ...
        public HDPublicKey childAt(string path, uint type = 0) {
        ...
        /// <param name="type">Type of public key. 0 = xpub, 1 = ypub, 2 = zpub.</param>
        public HDPublicKey childAt(HDPath path, uint type = 0) {

            HDPublicKey childKey = this; //set child to parent initially

            foreach (var level in path.hierarchies_) {
                childKey = childKey.childAt(level.child_, type);
            }
        ...
        /// <param name="type">Type of public key. 0 = xpub, 1 = ypub, 2 = zpub.</param>
        public HDPublicKey childAt(uint index, uint type) {
            ...
            return new HDPublicKey(childKey, chaincode, Depth_ + 1, fingerprint, index, testnet_, type);
        }
