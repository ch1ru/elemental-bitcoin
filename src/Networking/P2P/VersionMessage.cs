...
namespace LBitcoin.Networking.P2P {
    public class VersionMessage : GenericMessage {
        ...
        public Int64 Timestamp { get { return (Int64)timestamp_; } }
        ...
        public VersionMessage(int version = 70015, NetworkServices services = null, Int64 timestamp = 0,
            ...
            byte[] nonce = null, string userAgent = "/ElementaryBitcoin:0.1.0/",
            ...
            if (timestamp == 0) {
                ...
                timestamp_ = DateTime.UtcNow.Second - (new DateTime(1970, 1, 1)).Second;
            } else {
