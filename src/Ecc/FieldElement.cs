...
namespace LBitcoin.Ecc {
    ...
    /// <summary>
    /// Creates an element within a prime field.
    /// </summary>
    public class FieldElement {

        protected BigInteger num_;
        protected BigInteger prime_;

        protected FieldElement(FieldElement element) {
            this.num_ = element.num_;
            this.prime_ = element.prime_;
        }
        ...
        /// </summary>
        /// <param name="a">Base number to perform modulo on.</param>
        /// <param name="n">Modulo exponent.</param>
