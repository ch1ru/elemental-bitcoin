...
namespace LBitcoin.Ecc {
    ...
    public class PublicKey {
        ...
        public BitcoinAddress GetAddr(string addrType, bool testnet = false, bool isCompressed = true) {
            return new BitcoinAddress(this, addrType, testnet: testnet, isCompressed);
        }
